...
* Rename the downloadlicensepdf/ folder to the name of your module (eg "widget").
...
all the instances of the string "downloadlicensepdf" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/downloadlicensepdf/widget/g' {} \;

* Rename the file lang/en/downloadlicensepdf.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_downloadlicensepdf.php
...
and you should find that this downloadlicensepdf has been added to the list of
installed modules.
